...
/**
 * Representa uma data através do dia, mês e ano. Classe utilitária que foi
 * fornecida e usada em aulas de PPROG do DEI ISEP no ano letivo 2019/2020
 *
 * @author ISEP-DEI-PPROG (AULA PL16)
 */
public class Data implements Comparable<Data> {
     ...
     * @throws exception.DiaInvalidoException Dia inserido inválido
     */
    public final void setData(int ano, int mes, int dia) throws MesInvalidoException, DiaInvalidoException {
        if (mes < 1 || mes > 12) {
