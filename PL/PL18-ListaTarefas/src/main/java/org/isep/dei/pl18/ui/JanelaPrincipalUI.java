...
public class JanelaPrincipalUI implements Initializable {
    ...
    private static final String BOTAO_LIMPAR_TAREFA = "LimparTarefas";
    ...
    private void teclaRatoLibertadaAction(MouseEvent event) {
        if(event.getButton().equals(MouseButton.SECONDARY)){
            ...
            MenuItem miAdicionarTarefas= new MenuItem("Adicionar Tarefas Com Valores Aleatórios");
  ...
  public void atualizarListaTarefas(ListaTarefas.ORDENACAO ordem) {
    txtAreaTarefas.setText(ordem==ListaTarefas.ORDENACAO.INSERCAO ? appController.getListaTarefas() : appController.getListaTarefasPorPrioridade());
    btnLimparTarefas.setDisable(appController.listaVazia());
    }
}
